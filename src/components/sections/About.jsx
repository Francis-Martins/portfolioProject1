        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-8">
              <FadeIn delay={60}>
                <div className="inline-flex items-center gap-2.5 px-5 py-2.5 border border-primary/10 rounded-full w-full">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2 relative group">
                    ...
                    <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                        <div className="flex items-start gap-4 p-3 bg-primary/10 rounded-xl w-fit mb-4">
                            <Code2 className="w-6 h-6 text-primary"/> 
                        </div>
                        <div className="flex-1">
                            <h3 className="text-lg font-semibold text-white mb-2">Expertise</h3>
                            <p className="text-sm text-white/70 leading-relaxed">
                                Specialize in building scalable Websites
                            </p>
                        </div>
                    </div>
                ...
                <div className="relative group">
                    <div className="absolute inset-0 bg-liner-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300"></div>
                ...
                <div className="col-span-2 relative group">
                  <div className="aboslute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300"></div>
                  <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  <div className="grid grid-cols-3 gap-6 text-center">
                    ...
                    <div className="">
                        <div className="text-2xl font-bold text-primarytext-2xl font-bold text-primary">Fast</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl">
            {skills.map((skill, index) => (
                ...
                >
                    ...
                    {/* Hover Glow Effect */}
                    <div className="absolute inset-0 bg-linear-to-br- from primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/10 rounded-2xl transition-all duration300"></div>
                </div>
            ))}
        </div>
    </div>
