      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <FadeIn delay={0}>
              <div className="inline-flex items-center gap-2.5 px-[18px] py-[11px] rounded-full bg-linear-to-r from-primary/10 via-primary/15 to-primary/20 border-primary/20 mb-8">
          ...
          <FadeIn delay={200}>
            <p className="text-lg text-white/70 mb-8 max-w-[550px]">
             React developer building real projects, learning real lessons, 
             and always looking for people to build and grow with.
            </p>
          </FadeIn>
        ...
        <FadeIn delay={200}>
          ...
          <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group">
            <div className="absolute inset-0 rounded-2xl overflow-hidden">
              <div className="absolute inset-[-2px] bg-linear-to-r from-primary/10 via-primary/10 to-primary animate-spin-slow rounded-2xl">
