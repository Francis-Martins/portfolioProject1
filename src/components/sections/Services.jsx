...
const Services = () => {
  return <section id="services" className="relative py-20 bg-black overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-1/4 left-1/4 w-95 h-96  bg-primary/20 opacity-20 rounded-full blur-3xl" />
            <div className="absolute bottem-1/4 right-1/4 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl " />
                    ...
                    return (
                        <FadeIn key={service.id} delay={100 + index * 100}>
                            <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-[280px] flex flex-col">
                                <div className="mb-6">
                                    <div className="w-16 h-16 rounded bg-primary/20 border-primary/30 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
